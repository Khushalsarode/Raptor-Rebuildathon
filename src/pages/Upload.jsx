...
const handleRenameImage = (id, newName) => {
...
>
  ...
  <h2 className="text-xl font-semibold mb-4 text-ocean-lightText dark:text-ocean-darkText">
    Please fill in your Photo's details & Upload in the collection.
  </h2>
  <p className="mb-6 italic text-ocean-lightSecondary dark:text-ocean-darkSecondary">
    Click on the Dropdowm to select from a list of options.
  </p>

<div className="flex flex-col items-start gap-6 max-w-2xl mx-auto border border-ocean-lightSecondary dark:border-ocean-darkSecondary rounded-lg p-4">
      {/* Image Input */}
      <label className="block w-full">
        <span className="text-ocean-lightText dark:text-ocean-darkText font-medium mb-2 block">
          Upload Image(s)
        </span>
        <input
          type="file"
          ...
          className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4
            ...
            file:bg-ocean-lightPrimary file:text-white hover:file:bg-ocean-lightSecondary
            dark:file:bg-ocean-darkPrimary dark:file:text-white dark:hover:file:bg-ocean-darkSecondary"
        />
      </label>

      <div className="flex flex-wrap gap-4">
  {selectedImages.map(({ id, url, name }) => (
    <div
      key={id}
      className="relative max-w-xs border border-ocean-lightSecondary dark:border-ocean-darkSecondary rounded-lg p-2 shadow-md bg-ocean-lightBg2 dark:bg-ocean-darkBg2"
    >
      <img
        src={url}
        alt={name}
      ...
      <button
        ...
        className="absolute top-1 right-1 text-ocean-lightPrimary dark:text-ocean-darkPrimary bg-ocean-lightBg rounded-full p-1 shadow hover:bg-ocean-lightSecondary dark:hover:bg-ocean-darkSecondary transition"
      ...
      <input
        type="text"
        value={name}
        onChange={(e) => handleRenameImage(id, e.target.value)}
        className="mt-2 w-full border border-ocean-lightSecondary dark:border-ocean-darkSecondary rounded px-2 py-1 text-sm text-ocean-lightText dark:text-ocean-darkText bg-ocean-lightBg2 dark:bg-ocean-darkBg2 focus:outline-none focus:ring-2 focus:ring-ocean-lightPrimary dark:focus:ring-ocean-darkPrimary transition"
      ...
      {/* Info Note */}
      <p className="mt-4 text-sm italic text-ocean-lightText dark:text-ocean-darkText">
        Important: Your images will not be added to the site gallery until you add more information.
      </p>
    </div>
    <br />
...
{/* Date Selection */}
<fieldset className="flex-1 border border-ocean-lightSecondary dark:border-ocean-darkSecondary rounded p-4 flex flex-col items-center justify-center">
...
<label className="block">
  <span className="text-ocean-lightText dark:text-ocean-darkText font-medium mb-1 block">
    Description
  </span>
  <textarea
    name="description"
    ...
    className="w-full rounded border border-ocean-lightSecondary dark:border-ocean-darkSecondary bg-ocean-lightBg2 dark:bg-ocean-darkBg2 px-3 py-2 text-ocean-lightText dark:text-ocean-darkText focus:outline-none focus:ring-2 focus:ring-ocean-lightPrimary dark:focus:ring-ocean-darkPrimary transition"
  />
</label>
